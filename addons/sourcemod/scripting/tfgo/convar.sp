...
void ConVar_Init()
{
	...
	tfgo_halftime_duration = CreateConVar("tfgo_halftime_duration", "15", "Number of seconds that halftime lasts", _, true, 0.0, true, 300.0);
	tfgo_halftime_scramble = CreateConVar("tfgo_halftime_scramble", "0", "Whether the teams should be scrambled instead of switching sides");
