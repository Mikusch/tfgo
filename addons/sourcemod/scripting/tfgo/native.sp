...
public any NativeCall_GetWeapon(Handle plugin, int numParams)
{
...
public any NativeCall_RegisterMusicKit(Handle plugin, int numParams)
{
...
public any NativeCall_SetClientMusicKit(Handle plugin, int numParams)
{
